...
base_model_path = "/mnt/object/artifacts/medical-qa-model/optimal_model.pth"
...
"""
    ...
    if trainer.global_rank == 0:
        ...
        mlflow_logger.experiment.log_param(mlflow_logger.run_id, "base_model", base_model_path)
        mlflow_logger.experiment.log_param(mlflow_logger.run_id, "is_retrained", True)
    ...
    if trainer.global_rank == 0:
        ...
        if os.path.exists(os.path.join(model_save_path, "retrained_model.pth")):
            os.remove(os.path.join(model_save_path, "retrained_model.pth"))
        os.makedirs(model_save_path, exist_ok=True)
        torch.save(model.model.state_dict(), os.path.join(model_save_path, "retrained_model.pth"))
        print(f"Model saved to {model_save_path}/retrained_model.pth")
